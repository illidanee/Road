...
int __stdcall WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine, _In_ int nShowCmd)
{
	...
	while (true)
	{
		...
		glBegin(GL_QUADS);
		glTexCoord2d(0.0f, 0.0f), glVertex3f(-0.5f, -0.5f, 0.0f);
		glTexCoord2d(1.0f, 0.0f), glVertex3f(0.5f, -0.5f, 0.0f);
		glTexCoord2d(1.0f, 1.0f), glVertex3f(0.5f, 0.5f, 0.0f);
		glTexCoord2d(0.0f, 1.0f), glVertex3f(-0.5f, 0.5f, 0.0f);
		glEnd();
