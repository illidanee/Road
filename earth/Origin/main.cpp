...
int __stdcall WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine, _In_ int nShowCmd)
{
	...
	GLuint texture = CreateTextureFromFile("../res/image/earth.bmp");
	...
	while (true)
	{
		...
		if (angle > 360.0f)
			angle -= 360.0f;
		glm::mat4 model = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -2.5f)) * glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0.0f, 1.0f, 0.0f));
		glm::mat4 normalMatrix = glm::inverseTranspose(model);
